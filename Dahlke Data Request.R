...
IAmin<- read_sheet('https://docs.google.com/spreadsheets/d/1Dazv10GXyhBLlo3Ql-tcvQBdP_uoW73VNfc-Dq0TxkY/edit?usp=sharing', "Table_Statistics Dump")
...
ggplot(data=IAmin, aes(x=fdsnMg, y=FeedType))+
  stat_density_ridges(quantile_lines = TRUE, quantiles = 3)
